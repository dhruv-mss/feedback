...
A one-question-at-a-time feedback form for people who tried the Aesthetic
Clay Mirror kit, plus a simple admin page to read the responses.
...
2. **Create the table.** In your project, open the SQL Editor and run the
   ...
   but only a signed-in user can *read* them.
